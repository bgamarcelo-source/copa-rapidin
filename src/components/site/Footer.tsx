      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-10 md:grid-cols-3">
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <a href="https://wa.me/" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="rounded-full bg-[#25D366] p-2 text-white hover:brightness-110"><WhatsappIcon size={18} /></a>
          </div>
        </div>
        <div>
